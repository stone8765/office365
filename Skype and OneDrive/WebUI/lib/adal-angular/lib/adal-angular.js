            ...
            return {
                request: function (config) {
                    if (config) {
                        ...
                        var viaApi = false;
                        if (config.headers['x-request-office']) {
                            viaApi = false;
                        } else if (config.headers['x-request-office-byapi']) {
                            viaApi = true;
                            resource = authService.getResourceForEndpoint(config.headers['x-request-office-byapi']);
                        } else {
                            viaApi = false;
                        }
                        ...
                        if (tokenStored) {
                            ...
                            if (viaApi) {
                                config.data.accessToken = tokenStored;
                            } else {
