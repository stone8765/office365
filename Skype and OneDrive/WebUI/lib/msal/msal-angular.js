...
(function () {
    ...
    if (angular) {
        ...
        var MsalModule = angular.module('AdalAngular', []);

        MsalModule.provider('adalAuthenticationService', function () {
            var _msal = null;
            var _constants = null;
        ...
        MsalModule.factory('ProtectedResourceInterceptor', ['adalAuthenticationService', '$q', '$rootScope', '$templateCache', '$injector', function (authService, $q, $rootScope, $templateCache, $injector) {
